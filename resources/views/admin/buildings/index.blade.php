...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Manajemen Lantai FTMM</h1>
            <p class="text-gray-600">Kelola data gedung FTMM</p>
        </div>
        <div class="flex items-center space-x-4">
            <a href="{{ route('admin.buildings.create') }}" class="btn-primary">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
            <div class="flex items-center">
                <div class="flex-1">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $buildings->total() }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
            <div class="flex items-center">
                <div class="flex-1">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $buildings->sum('rooms_count') }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500">
            <div class="flex items-center">
                <div class="flex-1">
                    <p class="text-sm font-medium text-gray-600">Rata-rata Ruangan</p>
                    <p class="text-2xl font-bold text-gray-900">
                        {{ $buildings->count() > 0 ? number_format($buildings->sum('rooms_count') / $buildings->count(), 1) : 0 }}
                    </p>
                </div>
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-900">Daftar Gedung</h3>
        </div>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <a href="{{ route('admin.rooms.index', ['building' => $building->id]) }}" 
                                ...
                                <button onclick="showBuildingDeleteModal({{ $building->id }})" 
...
<div id="deleteModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white rounded-lg p-6 max-w-sm mx-4">
        ...
        <p class="text-sm text-gray-500 mb-6">Apakah Anda yakin ingin menghapus Lantai ini? Tindakan ini tidak dapat dibatalkan.</p>
        <div class="flex justify-end space-x-3">
            ...
            <form id="deleteForm" method="POST" action="{{ route('admin.buildings.destroy', $buildings) }}" class="inline">
                @csrf
                @method('DELETE')
...
<script>
function showBuildingDeleteModal(buildingId) {
    // Mengatur action form dengan ID gedung yang sesuai
    const deleteForm = document.getElementById('deleteForm');
    deleteForm.action = `/admin/buildings/${buildingId}`;
    
    // Menampilkan modal
